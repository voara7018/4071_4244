...
<div class="page-header animate-slideUp">
    ...
    <p class="page-subtitle">Ajoutez pourcentage pour les autres operateurs</p>
</div>
...
<div class="row animate-slideUp delay-1">
    <div class="col-lg-6">
        <div class="form-card">
            ...
            <form action="<?= base_url('commission/insert') ?>" method="post">
                                <div class="form-group-custom">
                    <label for="prefixes">Commission (%)</label>
                    <div class="input-group-custom">
                        <span class="input-prepend"><i class="bi bi-percent"></i></span>
                       <input type="number" id="prefixes" name="commission" class="form-input" 
